...
public abstract class LevelView {
	...
	protected Canvas canvas = new Canvas(800, 500);
	...
	protected Label bestScoreLabel;
	protected Label scoreImg = new Label();

	protected Image background = new Image("file:src/gui/related/background.jpg");
